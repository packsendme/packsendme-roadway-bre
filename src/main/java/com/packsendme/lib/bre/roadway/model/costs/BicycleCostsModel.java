...
public class BicycleCostsModel {
	...
	public void setCost_distance_bicycle(Double cost_distance_bicycle) {
		this.cost_distance_bicycle = cost_distance_bicycle;
	}
	...
	public Double getPercentage_reshipping_bicycle() {
		return percentage_reshipping_bicycle;
	}
	public void setPercentage_reshipping_bicycle(Double percentage_reshipping_bicycle) {
		this.percentage_reshipping_bicycle = percentage_reshipping_bicycle;
	}
	public Double getPercentage_storage_bicycle() {
		return percentage_storage_bicycle;
	}
